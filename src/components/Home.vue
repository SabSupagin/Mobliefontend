...
<div class="col-md-5">
    <div class="card">
         <div class="card-body">
              ...
              <a style="margin-left: 10%">จำนวนสินค้า</a>
              <a style="margin-left: 30%; font-size: 30px">{{products.length}}</a>
         </div>
    </div>
</div>
<br>
...
<div class="col-md-5">
    <div class="card">
         <div class="card-body">
              ...
              <a style="margin-left: 10%">จำนวนการใช้งาน</a>
    ...
    <div class="card">
         <div class="card-body">
            ...
            <path d="M.5 1a.5.5 0 0 0 0 1h1.11l.401 1.607 1.498 7.985A.5.5 0 0 0 4 12h1a2 2 0 1 0 0 4 2 2 0 0 0 0-4h7a2 2 0 1 0 0 4 2 2 0 0 0 0-4h1a.5.5 0 0 0 .491-.408l1.5-8A.5.5 0 0 0 14.5 3H2.89l-.405-1.621A.5.5 0 0 0 2 1H.5zM6 14a1 1 0 1 1-2 0 1 1 0 0 1 2 0zm7 0a1 1 0 1 1-2 0 1 1 0 0 1 2 0zm-1.646-7.646-3 3a.5.5 0 0 1-.708 0l-1.5-1.5a.5.5 0 1 1 .708-.708L8 8.293l2.646-2.647a.5.5 0 0 1 .708.708z"/>
              ...
              <a style="margin-left: 10%">จำนวนการสั่งซื้อ</a>
              <a style="margin-left: 22%; font-size: 30px">1,000</a>
         </div>
    </div>
</div>
<br>
...
<div class="col-md-5">
    <div class="card">
         <div class="card-body">
              ...
              <a style="margin-left: 10%">ยอดขาย</a>
              <a style="margin-left: 22%; font-size: 30px">3,000,000.00</a>
         </div>
    </div>
</div>
</div>
